...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  7 19:09:41 2023
...
from monai.transforms import (Transform, AddChanneld, Compose, LoadImaged, Transposed, ScaleIntensityd,
                              ...
                              ToTensor)
# The letter d after the transform name stands for dictionary (i.e., the transform expectsa dictionary as input) 
...
x = next(iter(loader))
print(x['img'].shape)
#plt.imshow(x['img'][11,130,:,:,0],cmap='gray')
#plt.imshow(x['img'][8,0,130,:,:],cmap='gray')
